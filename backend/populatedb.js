...
console.log(
  ...
  async function authorCreate(index, name, email, summary) {
    const authordetail = {
      name: name,
      email: email,
      summary: summary
  ...
  async function createAuthors() {
    ...
    await Promise.all([
      authorCreate(0, "Patrick Rothfuss", "patrick@example.com", "Award-winning fantasy author known for The Kingkiller Chronicle series."),
      authorCreate(1, "Ben Bova", "ben@example.com", "Prolific science fiction author and former editor of Analog magazine."),
      authorCreate(2, "Isaac Asimov", "isaac@example.com", "Legendary science fiction author known for the Foundation series and Robot series."),
      authorCreate(3, "Bob Billings", "bob@example.com", "Contemporary fiction writer focusing on modern social issues."),
      authorCreate(4, "Jim Jones", "jim@example.com", "Mystery and thriller author with multiple bestsellers.")
    ]);
  }
